        ...
        <div class="nav-content">
            ...
            <div style="position: relative; width: min(300px, 40vw);">
                <div style="position: relative; 
                           ...
                           backdrop-filter: blur(10px);
                           box-shadow: 0 5px 15px rgba(0,0,0,0.2);">
                    <input type="text" id="searchInput" placeholder="Search moons..." 
                           style="width: 100%; 
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        searchInput.addEventListener('input', function() {
            ...
            celestialBlocks.forEach(block => {
                const moonName = block.querySelector('h2 a').textContent.toLowerCase();
                
                if (moonName.includes(searchTerm)) {
            ...
            if (visibleBlocks.length === 0 && searchTerm !== '') {
                if (!noResultsMsg) {
                    ...
                    noResultsMsg.innerHTML = '<p>No moons found matching "' + searchTerm + '"</p>';
